# Playground for [Roots.io Example Project](https://github.com/roots/roots-example-project.com)

My personal playground for [Roots](http://roots.io) Projects ([Bedrock-Ansible](https://github.com/roots/bedrock-ansible), [Bedrock](https://github.com/roots/bedrock), [Sage](https://github.com/roots/sage)) with some opinionated modifications.
